...
if exists("*searchpairpos")
	...
	if !exists('g:fennel_fuzzy_indent_patterns')
		let g:fennel_fuzzy_indent_patterns = ['^def', '^let', '^while', '^if', '^fn$', '^var$', '^case$', '^for$', '^each$', '^local$', '^global$', '^match$', '^macro', '^lambda$', '^collect$', '^icollect$', '^fcollect$', '^accumulate$', '^faccumulate$']
	endif
